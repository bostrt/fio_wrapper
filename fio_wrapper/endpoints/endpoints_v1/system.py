...
from fio_wrapper.models.system_models import System as SystemModel, SystemList


class Storage(AbstractStorage, AbstractEndpoint):
    @apikey_required
    def get(self, username: str, timeout: Optional[float] = None) -> SystemList:
        ...
        if status == 200:
            return SystemList.model_validate(data)
